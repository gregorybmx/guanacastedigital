...
const FormularioDatosCRComponent = (props) => {
    return (
        <form>
            ...
            <div className="mb-3 mt-3">
                ...
                <input className="mb-3 form-control" type="id" placeholder="Ingrese su Cedula" aria-label="default input example"></input>
                ...
                <div className="mb-3">
                    <input type="text" className="form-control" id="inputAddress" placeholder="Ingrese su Direccion" />
                </div>

                <div className="mb-3">
                    <input type="password" className="form-control" placeholder="Contraseña" />
                
                    <input type="confirm-password" className="form-control mt-3" placeholder="Verifica tu Contraseña"/>
                </div>
            </div>
...
export default FormularioDatosCRComponent   
