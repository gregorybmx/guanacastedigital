...
import FormularioComponent from '../components/FormularioReportesVentasSocioComercial'
import logo from '../img/gd_logo.png'

const SalesReportBPRegister = () => {
          ...
          <div className="wrapper">
              <div className="wrapper-content">
                  ...
                  <div id='gdLogo'>
                      ...
                      <br></br>
                      <h2 className="text-center">Resgistro de Reporte de Ventas</h2>
                  </div>
...
export default SalesReportBPRegister